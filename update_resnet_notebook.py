...
notebook_path = r"d:\New folder\sis_fall_har_and_fall-detection_trainning\train_v30_resnet1d_optimize\train_v30_resnet1d_optimize.ipynb"
...
for cell in nb['cells']:
    if cell['cell_type'] == 'code':
        ...
        # Modify the model definition cell
        if "def build_model" in source and "def se_block_v25" in source:
...
def se_block_v25(x, c, ratio=4):
    ...
    # TỐI ƯU: Thay thế Sigmoid (chậm) bằng Hard-Sigmoid (dùng relu6)
...
"""
        ...
        # Modify the trainer initialization to change output dir and version
        if "trainer = DataPreprocessor(" in source:
            source = source.replace('version="v30_resnet1d"', 'version="v30_resnet1d_optimize"')
            source = source.replace("out_dir='train_v30_resnet1d'", "out_dir='train_v30_resnet1d_optimize'")

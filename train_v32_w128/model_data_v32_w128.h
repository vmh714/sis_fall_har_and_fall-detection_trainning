// ============================================================
// AUTO-GENERATED model data  --  v32_w128
// TFLite INT8 size : 25080 bytes
// ------------------------------------------------------------
// Input  : shape=[np.int32(1), np.int32(128), np.int32(6)] dtype=int8 quant(scale=0.0078431377, zero_point=-1)

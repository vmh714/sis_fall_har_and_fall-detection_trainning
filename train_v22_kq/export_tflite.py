...
model_path = os.path.join(ROOT_DIR, 'train_v22_kq', 'best_model_v22.keras')
tflite_path = os.path.join(ROOT_DIR, 'model_v22_int8.tflite')
cc_path = os.path.join(ROOT_DIR, 'model_data_v22.cc')
h_path = os.path.join(ROOT_DIR, 'model_data_v22.h')
...
// TCN v22 Model for Fall Detection (INT8 Quantized)

...
OUT_DIR = Path(r'c:\Users\hung.vumanh2\Documents\SisFall-PreProcessing\train_v6_kq')
...
def main():
    ...
    checkpoint_path = OUT_DIR / 'best_model_v6.keras'
    callbacks = [
    ...
    plt.tight_layout()
    plt.savefig(OUT_DIR / 'training_history_v6.png')
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(OUT_DIR / 'confusion_matrix_v6.png')
    plt.close()
    print("[*] Đã vẽ và lưu ma trận nhầm lẫn thành 'confusion_matrix_v6.png'")
    
    report_str += "\n[*] Đã vẽ và lưu ma trận nhầm lẫn thành 'confusion_matrix_v6.png'\n"

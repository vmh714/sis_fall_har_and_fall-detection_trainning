...
def main():
    ...
    checkpoint_path = CURRENT_DIR / 'best_model.keras'
    callbacks = [
    ...
    plt.tight_layout()
    plt.savefig(CURRENT_DIR / 'training_history.png')
    plt.close()
    ...
    plt.close()
    print("[*] Đã vẽ và lưu ma trận nhầm lẫn thành 'confusion_matrix.png'")

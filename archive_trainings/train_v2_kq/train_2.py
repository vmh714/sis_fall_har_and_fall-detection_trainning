...
def main():
    ...
    checkpoint_path = CURRENT_DIR / 'best_model_v2.keras'
    callbacks = [
    ...
    plt.tight_layout()
    plt.savefig(CURRENT_DIR / 'training_history_v2.png')
    plt.close()
    print("[*] Đã vẽ và lưu đồ thị lịch sử huấn luyện thành 'training_history_v2.png'")
    ...
    plt.tight_layout()
    plt.savefig(CURRENT_DIR / 'confusion_matrix_v2.png')
    plt.close()
    print("[*] Đã vẽ và lưu ma trận nhầm lẫn thành 'confusion_matrix_v2.png'")
